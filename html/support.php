...
<em>support@<span
class="hide">remove-this-first@</span>xdebug.org</em>.  If you like Xdebug
and make use of it, feel free to checkout my <?php url('giftlist', 'wishlist');
?> or become a patron on <a
href='https://www.patreon.com/bePatron?u=7864328'>Patreon</a>. This improves
chances that I will be continuing developing Xdebug as an open source
extension.
</p>
<p>
Support through e-mail is give on a best-effort basis only.
</p>
