...
foreach (['show_error_trace' => array(
		'integer', 0, ">= 2.4",
...
",
	...
	'collect_return' => array(
		'boolean', 0, null,
		"<p>This setting, defaulting to 0, controls whether Xdebug should write the
return value of function calls to the trace files.</p>
<p>For computerized trace files ([CFG:trace_format]=1) this only works from Xdebug 2.3 onwards.</p>",
		FUNC_FUNCTION_TRACE,
	),
...
",
	...
	'remote_host' => array(
		...
		"<p>Selects the host where the debug client is running, you can either use a
host name, IP address, or 'unix:///path/to/sock' for a Unix domain socket.
This setting is ignored if [CFG:remote_connect_back] is enabled.</p>
<p>Support for Unix domain sockets was introduced in Xdebug 2.6.</p>",
		FUNC_REMOTE
	),
...
",
	...
	'coverage_enable' => array(
	    ...
	    file_put_contents(__DIR__ . '/settings/' . $i . '.php', $arr[3]);
