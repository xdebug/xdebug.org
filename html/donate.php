<?php $title = "Xdebug: Donate"; include "include/header.php"; hits ('xdebug-donate'); ?>
		<tr>
			<td>&nbsp;</td>
			<td><span class="serif">
...
<p>You can donate through Google Checkout by selecting an option and clicking on the "Buy Now" logo.</p>
<p><b>Disclaimer:</b> You're not *buying* anything, you're just providing a
donation because Xdebug saves you time!</p>

<div align="center">
<form action="https://checkout.google.com/api/checkout/v2/checkoutForm/Merchant/744876371445067" id="BB_BuyButtonForm" method="post" name="BB_BuyButtonForm" target="_top">
    <table cellpadding="5" cellspacing="0" width="1%">
        <tr>
            <td align="right" width="1%">
                <select name="item_selection_1">
                    <option value="1">£5.00 - Xdebug donation (mini)</option>
                    <option value="2">£10.00 - Xdebug donation (small)</option>
                    <option value="3" selected="yes">£25.00 - Xdebug donation (medium)</option>
                    <option value="4">£50.00 - Xdebug donation (large)</option>
                    <option value="5">£100.00 - Xdebug donation (mega)</option>
                    <option value="6">£250.00 - Xdebug donation (über-mega)</option>
                </select>
                <input name="item_option_name_1" type="hidden" value="Xdebug donation (mini)"/>
