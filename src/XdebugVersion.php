...
class XdebugVersion
{
    ...
    public const LATEST_WINDOWS_VERSION = '3.5.3';
    ...
    private const VERSIONS =  [
        ...
        '8.2' => [ 'src' => '3.5.3',       'win' => '3.5.3' ],
        '8.3' => [ 'src' => '3.5.3',       'win' => '3.5.3' ],
        '8.4' => [ 'src' => '3.5.3',       'win' => '3.5.3' ],
        '8.5' => [ 'src' => '3.5.3',       'win' => '3.5.3' ],
        '8.6' => [ 'src' => '3.6.0alpha1', 'win' => '3.6.0alpha1' ],
    ];
