...
class XdebugVersion
{
    ...
    public const LATEST_VERSION = '3.4.6';
    public const LATEST_WINDOWS_VERSION = '3.4.6';
    ...
    private const VERSIONS =  [
        ...
        '8.0' => [ 'src' => '3.4.6',       'win' => '3.4.6' ],
        '8.1' => [ 'src' => '3.4.6',       'win' => '3.4.6' ],
        '8.2' => [ 'src' => '3.4.6',       'win' => '3.4.6' ],
        '8.3' => [ 'src' => '3.4.6',       'win' => '3.4.6' ],
        '8.4' => [ 'src' => '3.4.6',       'win' => '3.4.6' ],
    ];
