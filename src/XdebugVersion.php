...
class XdebugVersion
{
    ...
    public const LATEST_VERSION = '3.5.1';
    public const LATEST_WINDOWS_VERSION = '3.5.1';
    ...
    private const VERSIONS =  [
        ...
        '8.0' => [ 'src' => '3.5.1',       'win' => '3.5.1' ],
        '8.1' => [ 'src' => '3.5.1',       'win' => '3.5.1' ],
        '8.2' => [ 'src' => '3.5.1',       'win' => '3.5.1' ],
        '8.3' => [ 'src' => '3.5.1',       'win' => '3.5.1' ],
        '8.4' => [ 'src' => '3.5.1',       'win' => '3.5.1' ],
        '8.5' => [ 'src' => '3.5.1',       'win' => '3.5.1' ],
    ];
	...
	public function determineSupported(): string|bool
	{
		...
		if ( $this->windows )
		{
			...
			if ( $this->winCompiler != 16 && ( $majorPhpVersion == '8.0' || $majorPhpVersion == '8.1'  || $majorPhpVersion == '8.2' ) )
			{
