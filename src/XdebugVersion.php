...
class XdebugVersion
{
    ...
    public const LATEST_VERSION = '3.2.2';
    public const LATEST_WINDOWS_VERSION = '3.2.2';
    ...
    private const VERSIONS =  [
        ...
        '8.0' => [ 'src' => '3.3.0',       'win' => '3.3.0' ],
        '8.1' => [ 'src' => '3.3.0',       'win' => '3.3.0' ],
        '8.2' => [ 'src' => '3.3.0',       'win' => '3.3.0' ],
        '8.3' => [ 'src' => '3.3.0',       'win' => '3.3.0' ],
    ];
