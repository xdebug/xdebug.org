...
class XdebugVersion
{
    public const NOT_SUPPORTED_BEFORE = '3.2';
    public const LATEST_VERSION = '3.2.0';
    public const LATEST_WINDOWS_VERSION = '3.2.0';
    ...
    private const VERSIONS =  [
        ...
        '8.0' => [ 'src' => '3.2.0',       'win' => '3.2.0' ],
        '8.1' => [ 'src' => '3.2.0',       'win' => '3.2.0' ],
        '8.2' => [ 'src' => '3.2.0',       'win' => '3.2.0' ]
    ];
