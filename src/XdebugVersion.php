...
class XdebugVersion
{
    ...
    public const LATEST_VERSION = '3.4.0';
    public const LATEST_WINDOWS_VERSION = '3.4.0';
    ...
    private const VERSIONS =  [
        ...
        '8.0' => [ 'src' => '3.4.0',       'win' => '3.4.0' ],
        '8.1' => [ 'src' => '3.4.0',       'win' => '3.4.0' ],
        '8.2' => [ 'src' => '3.4.0',       'win' => '3.4.0' ],
        '8.3' => [ 'src' => '3.4.0',       'win' => '3.4.0' ],
        '8.4' => [ 'src' => '3.4.0',       'win' => '3.4.0' ],
    ];
