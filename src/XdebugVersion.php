...
class XdebugVersion
{
	...
	public const LATEST_VERSION = '2.9.5';
	public const LATEST_WINDOWS_VERSION = '2.9.5';

	private const VERSIONS =  [
		'7.0' => [ 'src' => '2.8.1',                              ],
		'7.1' => [ 'src' => '2.9.5',       'win' => '2.9.5'       ],
		'7.2' => [ 'src' => '2.9.5',       'win' => '2.9.5'       ],
		'7.3' => [ 'src' => '2.9.5',       'win' => '2.9.5'       ],
		'7.4' => [ 'src' => '2.9.5',       'win' => '2.9.5'       ]
	];
