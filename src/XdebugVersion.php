...
class XdebugVersion
{
    ...
    public const LATEST_VERSION = '3.3.2';
    public const LATEST_WINDOWS_VERSION = '3.3.2';
    ...
    private const VERSIONS =  [
        ...
        '8.0' => [ 'src' => '3.3.2',       'win' => '3.3.2' ],
        '8.1' => [ 'src' => '3.3.2',       'win' => '3.3.2' ],
        '8.2' => [ 'src' => '3.3.2',       'win' => '3.3.2' ],
        '8.3' => [ 'src' => '3.3.2',       'win' => '3.3.2' ],
        '8.4' => [ 'src' => '3.4.0alpha1', 'win' => '3.4.0alpha1' ],
    ];
