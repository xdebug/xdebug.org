...
class XdebugVersion
{
    ...
    public const LATEST_VERSION = '3.3.1';
    public const LATEST_WINDOWS_VERSION = '3.3.1';
    ...
    private const VERSIONS =  [
        ...
        '8.0' => [ 'src' => '3.3.1',       'win' => '3.3.1' ],
        '8.1' => [ 'src' => '3.3.1',       'win' => '3.3.1' ],
        '8.2' => [ 'src' => '3.3.1',       'win' => '3.3.1' ],
        '8.3' => [ 'src' => '3.3.1',       'win' => '3.3.1' ],
    ];
