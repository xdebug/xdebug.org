...
class XdebugVersion
{
    ...
    public const LATEST_VERSION = '3.1.1';
    public const LATEST_WINDOWS_VERSION = '3.1.1';

    private const VERSIONS =  [
        '7.0' => [ 'src' => '2.8.1',                        ],
        '7.1' => [ 'src' => '2.9.8',       'win' => '2.9.8' ],
        '7.2' => [ 'src' => '3.1.1',       'win' => '3.1.1' ],
        '7.3' => [ 'src' => '3.1.1',       'win' => '3.1.1' ],
        '7.4' => [ 'src' => '3.1.1',       'win' => '3.1.1' ],
        '8.0' => [ 'src' => '3.1.1',       'win' => '3.1.1' ],
