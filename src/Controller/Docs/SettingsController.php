...
class SettingsController
{
    private const SETTINGS = [
        'collect_vars' => [
            'boolean', 0, null,
            DocsController::FUNC_STACK_TRACE
        ],
        'default_enable' => [
            'boolean', 1, null,
            DocsController::FUNC_BASIC
        ],
        'extended_info' => [
            'integer', 1, null,
            DocsController::FUNC_REMOTE
        ],
        ...
        'show_mem_delta' => [
            'integer', 0, null,
            DocsController::FUNC_STACK_TRACE | DocsController::FUNC_FUNCTION_TRACE
        ],

        'var_display_max_children' => [
            'integer', 128, null,
            DocsController::FUNC_STACK_TRACE | DocsController::FUNC_FUNCTION_TRACE | DocsController::FUNC_VAR_DUMP
        ],
        ...
        'cli_color' => [
            'integer', 0, '>= 2.2',
            DocsController::FUNC_STACK_TRACE | DocsController::FUNC_VAR_DUMP
        ],

        'auto_trace' => [
            'boolean', 0, null,
            DocsController::FUNC_FUNCTION_TRACE
        ],
        ...
        'collect_includes' => [
            'boolean', 1, null,
            DocsController::FUNC_FUNCTION_TRACE | DocsController::FUNC_STACK_TRACE
        ],
        ...
        'gc_stats_enable' => [
            'bool', 'false', '>= 2.6',
            DocsController::FUNC_GARBAGE_COLLECTION
        ],
        ...
        'coverage_enable' => [
            'boolean', 1, '>= 2.2',
            DocsController::FUNC_CODE_COVERAGE
        ],
    ];
    ...
    public static function getRelatedSettings(?int $func) : array
    {
        ...
        foreach ($settings as $name => $setting) {
            ...
            $setting_file = dirname(__DIR__, 3) . '/html/docs/include/settings/' . $name . '.php';
